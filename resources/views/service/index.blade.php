                ...
                <section class="modern-heading-services">
                    <div class="inner">
                        <h2 class="heading-secondary-services">
                            <span class="head-before">Le </span><span class="head-highlight">processus</span><span class="head-after"> de la conception de site web</span>
                        </h2>
                    </div>
                    <div class="markdown prose w-full break-words dark:prose-invert light"><ol><li><span style="color: #88349c;"><strong>Consultation initiale :</strong></span> Nous discutons ensemble des besoins et des objectifs pour votre site web afin d’établir une vision précise et alignée avec votre marque.</li><li><span style="color: #88349c;"><strong>Cahier de charges :</strong></span> Nous passons à l’élaboration d’un document complet détaillant le design, les fonctionnalités et les délais pour orienter le projet de manière claire.</li><li><span style="color: #88349c;"><strong>Installation et configuration :</strong></span><p>Nous mettons en place l’environnement de développement (hébergement et nom de domaine compris) avec WordPress et les outils nécessaires pour lancer la construction du site.</p></li><li><span style="color: #88349c;"><span style="color: #88349c;"><strong>Développement et design :</strong></span></span><p>Nous concevons la structure et le design du site en respectant votre charte graphique et en optimisant l’expérience utilisateur.</p></li><li><span style="color: #88349c;"><strong>Révisions et ajustements :</strong></span><p>Nous procédons à des discussions et modifications itératives pour garantir votre satisfaction totale avant la livraison finale.</p></li><li><span style="color: #88349c;"><strong>Livraison et support : </strong></span>Nous finalisons le site en vous offrant une formation de base et un support continu pour assurer son succès et répondre à vos besoins futurs.<div class="mt-1 flex gap-3 empty:hidden juice:-ml-3"><div class="items-center justify-start rounded-xl p-1 flex">&nbsp;</div></div></li></ol></div>
