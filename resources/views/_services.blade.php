<div class="mt-16">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
        ...
        <a href="{{ route('services.developpement') }}" class="scale-100 p-6 bg-violet-100 dark:bg-violet-800/50 dark:bg-gradient-to-bl from-violet-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-violet-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
            <div>
        ...
        <a href=" {{ route('services.consultation') }} " class="scale-100 p-6 bg-violet-100 dark:bg-violet-800/50 dark:bg-gradient-to-bl from-violet-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-violet-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
            <div>
                <div class="h-16 w-16 bg-violet-50 dark:bg-violet-800/20 flex items-center justify-center rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="w-7 h-7 stroke-white">
        ...
        <a href=" {{route('services.support') }} " class="scale-100 p-6 bg-violet-100 dark:bg-violet-800/50 dark:bg-gradient-to-bl from-violet-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-violet-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
            <div>
                <div class="h-16 w-16 bg-violet-50 dark:bg-violet-800/20 flex items-center justify-center rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="w-7 h-7 stroke-white">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M14.74 9.67L12 12.41m2.74-2.74a2.5 2.5 0 013.53 0l1.06 1.06a2.5 2.5 0 010 3.53l-4.13 4.13a2.5 2.5 0 01-3.53 0l-1.06-1.06a2.5 2.5 0 010-3.53m4.13 4.13L9.5 9.5m0 0L7.76 7.76a1.5 1.5 0 00-2.12 0L4.5 8.9a1.5 1.5 0 000 2.12l5.62 5.62a1.5 1.5 0 002.12 0l1.14-1.14a1.5 1.5 0 000-2.12L9.5 9.5z" />
                    </svg>
                </div>
                ...
                <p class="mt-4 text-white text-sm leading-relaxed">
                    Réalisation de maintenance applicative sur votre thème, contenu et cœur de WordPress, ainsi que la 
                    création de plugins sur mesure pour répondre à vos besoins spécifiques.
                </p>
            </div>
        </a>
    </div>
